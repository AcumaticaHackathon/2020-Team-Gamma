...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function postLog() {
            var refNbr = document.getElementById("ctl00_phF_form_t0_edOrderNbr_text").value;
            var orderType = document.getElementById("ctl00_phF_form_t0_edOrderType_text").value;
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    ...
                    "screenId": "SO301000", "userId": userId, "refNbr": refNbr,
                    "docType": orderType, "action": action
                }),

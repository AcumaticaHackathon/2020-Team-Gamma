...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Invoice Summary"
		...
		<Template>
			...
			<px:PXTextEdit ID="edUsrInserted" runat="server" DataField="UsrInserted" CommitChanges="True" CssClass="hideControl" />
		</Template>
	</px:PXFormView>
	<style type="text/css">
		.hideControl {
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
						...
						<Levels>
							<px:PXGridLevel DataMember="ccProcTran">
								...
								<RowTemplate>
									...
									<px:PXNumberEdit ID="edTransactionID" runat="server" DataField="TransactionID" />
								...
								<Columns>
									...
									<px:PXGridColumn DataField="TransactionID" TextAlign="Right" />
	...
	<script type="text/javascript">
        ...
        function postLog() {
            var refNbr = document.getElementById("ctl00_phF_form_t0_edRefNbr_text").value;
            var action = document.getElementById("ctl00_phF_form_t0_edUsrInserted").value
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    ...
                    "screenId": "SO303000", "userId": userId, "refNbr": refNbr,
                    "docType": params.get("DocType"), "action": action
                }),
        ...
        $(".main-Save, .main-Cancel, .main-Remove, .main-AddNew, .main-PagePrev, .main-PageFirst, .main-PageNext, .main-PageLast").
            click(function () {
				postLog();
        });
